...
export const heroData = {
  ...
  serviceCards: [
    {
      label: "New Hospital Development",
      desc: "The Indonesian government estimate around half a million new hospital beds",
      image: "/DEVELOP HOSPITAL.svg"
    },
    {
      label: "Expand a Hospital",
      desc: "Our business tools and experienced consultants can also support initiatives..",
      image: "/EXPAND THE HOSPITAL.svg"
    },
    {
      label: "Make a Business Plan",
      desc: "A watertight business plan may sound like a really obvious place to startstrategy...",
      image: "/MAKE A BUSINESS PLAN.png"
    },
    {
      label: "Implement a Business Plan",
      desc: "Not only does HCM excellence providea precise and exacting business strategy...",
      image: "/IMPLEMENT BUSSINESS.svg"
    },
    {
      label: "Hospital Turn-Around",
      desc: "Hospital beds are at a premium and more and more are needed but what if the ones...",
...
export const aboutSectionMeta = [
  {
    id: "beginning",
    image: "/new-images/GEDUNG 1.jpg",
    imageAlt: "Healthcare institution building blocks",
    type: "paragraphs" as const,
    titleColor: "coral" as const,
    subsectionColors: []
  },
  {
    id: "challenges",
    image: "/new-images/IMAGE CHALENGE.jpg",
    imageAlt: "Hospital technology challenges",
  ...
  {
    id: "gap-philosophy",
    image: "/new-images/IMAGE GAP.jpg",
    imageAlt: "Healthcare gap and philosophy",
    type: "subsections" as const,
    titleColor: "coral" as const,
    subsectionColors: ["coral", "coral"]
  },
  {
    id: "partner",
    image: "",
...
export const newsArticleImages: Record<string, string> = {
  "transformasi-besar-dharma-nugraha-hospital": "/crop.jpeg",
  "akses-layanan-kesehatan-humanis-terjangkau": "/test.jpeg",
  ...
  "industri-rs-makin-kompetitif-transformasi-sistem": "/article1.jpeg",
  "transforming-hospitals-from-the-inside-out": "/Rima.png",
